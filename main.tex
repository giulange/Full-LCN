...
%A low-cost movable station for fast and effective agroclimatic monitoring
...
\begin{figure}
    \centering
    \includegraphics[scale=.20]{lcn_board.jpg} % angle=270,scale=0.35
...
\begin{figure*}
    \centering
    \subfloat[March 2019]{\includegraphics[height=0.13\paperheight]{March_10_minute_avg_air_temperature.eps}}
    \hspace{5mm}
    \subfloat[April 2019]{\includegraphics[height=0.13\paperheight]{April_10_minute_avg_air_temperature.eps}}
...
\begin{figure*}
    \centering
    \subfloat[March 2019]{\includegraphics[height=0.13\paperheight]{March_hourly_avg_mean_air_temperature.eps}}
    \hspace{5mm}
    \subfloat[April 2019]{\includegraphics[height=0.13\paperheight]{April_hourly_avg_mean_air_temperature.eps}}
